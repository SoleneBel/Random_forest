...
def random_forest():
    ...
    # Random Forest
    # changement des poids des catégories
    weights = {
        LABEL_MAP['water']: 1.5,
        LABEL_MAP['green_area']: 0.5,
        LABEL_MAP['urban']: 1.2
    }
...
def get_color_for_category(category):
    ...
    color_map = {
        ...
        "urban": (128, 128, 128, 128)  # Gris semi-transparent
    }
...
if __name__ == '__main__':
    ...
    colorize_image_with_rectangles(TARGET_PATH, 40, 30, "result_2.png", scaler, pca, clf)
